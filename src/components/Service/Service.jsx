                        ...
                        <div className="service-card">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="57" height="57" viewBox="0 0 57 57" fill="none">
                                    <circle cx="28.5" cy="28.5" r="28" fill="#FF7F00" fillOpacity="0.01" stroke="#FF7F00"></circle>
                                    <path d="M20.4375 28H34.875M30.0625 22.5L35.5625 28L30.0625 33.5" stroke="#FF7F00" strokeWidth="1.83333" strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>Book a Call
                            </a>
                        </div>
                    </div>
